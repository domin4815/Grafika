...
function init() {
	...
	var planet1 = createPlanet(30, 0.5, "sun.jpg", 0.5, 0.00);
	planet1.position.x = 0;
	planet1.position.z = 0;
	planets.push(planet1);

	var planet2 = createPlanet(20, 0.5, "jo.jpg", 1, 0.04);
	planet2.setGravitySource(planet1, 70, 0, 0.01);
	planets.push(planet2);
	
	var planet3 = createPlanet(10, 0.5, "mars.jpg", 1, 0.03);
	planet3.setGravitySource(planet2, 40, 0, 0.03);
	planets.push(planet3);
	
	var planet4 = createPlanet(15, 0.5, "metal-rust.jpg", 1, 0.04);
	planet4.setGravitySource(planet1, 75, Math.PI/2, 0.01);
	planets.push(planet4);
	
	var planet5 = createPlanet(15, 0.5, "uranus.jpg", 1, 0.04);
